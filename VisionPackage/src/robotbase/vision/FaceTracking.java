...
//
//	// run
//	Bitmap bitmap = Bitmap.createBitmap(NativeCameraService.camWidth,
//			NativeCameraService.camHeight, Bitmap.Config.ARGB_8888);
//
...
//			Bundle fdBundle = intent.getBundleExtra("bundle");
...
//		// Computation
//		Mat originalFrame = new Mat(NativeCameraService.camHeight,
//				NativeCameraService.camWidth, CvType.CV_8UC1);
...
//						if (opencv_rect.width > NativeCameraService.camWidth) {
